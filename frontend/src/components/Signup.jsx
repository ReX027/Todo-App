  ...
  const handleRegister = async (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      try {
        ...
        const extractedErrorMessage = doc
          .querySelector("pre")
          .textContent.trim();
          ...
          >
            ...
            <form onSubmit={handleRegister}>
              ...
              <div className="field-wrap">
                ...
                />
                {errors.email && (
                  <label className="error-message">{errors.email}</label>
                )}
                {existedEmailerror && (
                  <label className="error-message">{existedEmailerror}</label>
                )}
              </div>
              ...
              <div className="field-wrap">
                ...
                />
                {errors.username && (
                  <label className="error-message">{errors.username}</label>
                )}
                {existedUsererror && (
                  <label className="error-message">{existedUsererror}</label>
                )}
              </div>
              ...
              <div className="field-wrap">
                ...
                />
                {errors.password && (
                  <label className="error-message">{errors.password}</label>
                )}
              </div>
